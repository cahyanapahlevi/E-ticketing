...
class ProgrammerController extends Controller
{
    ...
    {
		 $pm= DB::table('proyek')->join('proyek_user','proyek_user.ID_PROYEK','=','proyek.ID_PROYEK')->where('proyek_user.ID_PROGRAMER','=',Session::get('ID_PROGRAMER'))->get();/*24-4-2019*/
		  $op= DB::table('tiket')->join('proyek_user','proyek_user.ID_PROYEK','=','tiket.ID_PROYEK')
		  ->where('proyek_user.ID_PROGRAMER','=',Session::get('ID_PROGRAMER'))
        ...
        $datediff1 = DB::table('proyek')
          ...
          if(!Session::get('login')){
            ...
            return view('programmer/home',['cek_project'=>$cek_project, 'cek_komentar'=>$cek_komentar,'foto'=>$foto,'datediff'=>$datediff,'datediff1'=>$datediff1,'sekarang'=>$sekarang,'pm'=>$pm, 'op'=>$op]);
        }
    }
	...
	public function update_profile(Request $request)
{
   ...
   public function aktifitas()
	...
	public function proyek()
	{
		...
		return view('programmer/proyek',compact('pm'),['cek_project'=>$cek_project, 'cek_komentar'=>$cek_komentar,'foto'=>$foto,'datediff'=>$datediff,'datediff1'=>$datediff1,'sekarang'=>$sekarang]);
	}
	...
	public function onprogress()
	{
		...
		$cek_project = DB::table('proyek')->where('BACA','=','BELUM')->orderBy('ID_PROYEK','desc')->get();
         $cek_komentar = DB::table('komentar AS k')
            ...
            ->limit(5)
            ->get();
            $foto = DB::table('programer')->where('ID_PROGRAMER',Session::get('ID_PORGRAMER'))->get();
         $sekarang = Carbon::now()->format('Y-m-d');
		...
		return view('programmer/onprogress',compact('op'),['cek_project'=>$cek_project, 'cek_komentar'=>$cek_komentar,'foto'=>$foto,'datediff'=>$datediff,'datediff1'=>$datediff1,'sekarang'=>$sekarang]);
	}
