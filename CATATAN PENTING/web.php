...
Route::get('/programmer/proyek', 'ProgrammerController@proyek'); //24-4-2019
Route::get('/programmer/onprogress', 'ProgrammerController@onprogress'); //24-4-2019
...
Route::get('/manager/cariaktifitas', 'ManagerController@cariaktifitas'); 
