      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            ...
            @endif
              <form action="{{url('/manager/masuk')}}" method="post">
                {{ @csrf_field() }}
                <div class="form-group">
                  <label class="label">Username</label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Username" name="nama_manager">
                ...
                <div class="form-group">
                  <button class="btn btn-primary submit-btn btn-block" value="submit">Login</button>
                </div>
              </form>
            </div>
