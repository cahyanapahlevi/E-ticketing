    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{url('/programmer/home')}}">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                <a class="dropdown-item" href="{{url('programmer/ticket')}}">
              ...
              <a class="dropdown-item preview-item" href="{{url('programmer/ticket/detail_tiket',$df->ID_PROYEK)}}">
           ...
           <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <div class="dropdown-divider"></div>
              <a class="dropdown-item preview-item" href="{{url('programmer/baca',$cp->ID_PROYEK)}}">
                <div class="preview-item-content flex-grow">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdow">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item preview-item" href="{{url('programmer/ticket/detail_tiket',$cek->ID_PROYEK)}}">
                <div class="preview-item-content flex-grow">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="{{url('/programmer/logout_p')}}">
                Sign Out
              </a>
            </div>
          </li>
